...
class word(ListAnalysis):
    ...
    def found_in_dict(self) -> "bool":
        return _freeling.word_found_in_dict(self)

    def set_found_in_dict(self, arg2: 'bool') -> "void":
    ...
    def add_alternative(self, arg2: 'std::wstring const &', arg3: 'int') -> "void":
    ...
    def get_alternatives(self, *args) -> "std::list< std::pair< std::wstring,int >,std::allocator< std::pair< std::wstring,int > > > const &":
        return _freeling.word_get_alternatives(self, *args)

    def alternatives_begin(self, *args) -> "std::list< std::pair< std::wstring,int >,std::allocator< std::pair< std::wstring,int > > >::const_iterator":
        return _freeling.word_alternatives_begin(self, *args)

    def alternatives_end(self, *args) -> "std::list< std::pair< std::wstring,int >,std::allocator< std::pair< std::wstring,int > > >::const_iterator":
...
class mention(_object):
    ...
    def subsumed_with_no_verb(self, b: 'bool'=False) -> "void":
    ...
    def is_subsumed_with_no_verb(self) -> "bool":
...
class lang_ident(_object):
    ...
    def rank_languages(self, *args) -> "void":
...
class alternatives(_object):
    ...
    def get_similar_words(self, arg2: 'std::wstring const &', arg3: 'std::list< std::pair< std::wstring,int >,std::allocator< std::pair< std::wstring,int > > > &') -> "void":
